...
<body>
	<select name="ad_sido" id="selectAdSido" onchange=changeSelectSido();>
...
selected
	...
	<script>
		...
		function changeSelectSido() {
			var adSido = document.querySelector('#selectAdSido').value;
			location.href = "/addr/list?adSido=" + adSido;	
		}
